...
namespace mvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed() //popula db
        {
          // if (_context.Department.Any() || _context.Seller.Any() || _context.SalesRecord.Any()) //Testa se existe registro
           // {
          //      return; //DB has been seeded
          //  }
            Department d1 = new Department(1, "Computeres");
            Department d2 = new Department(2, "Eletronics");
            Department d3 = new Department { Id = 3, Name = "Fashion" }; //ex sem construtor
